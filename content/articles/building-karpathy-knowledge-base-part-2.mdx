...
date: 2026-04-05
excerpt: "You don't need LangChain or a vector database. A Pi SDK session that can read files IS a retrieval system. Here's how to build Karpathy's knowledge base with tool-scoped agent sessions."
template: "technical"
...
This post is the how. And the answer is simpler than I expected: **a Pi SDK session that can read files IS a retrieval system.** You don't need LangChain. You don't need a retrieval pipeline. You need an agent with tool permissions.

---

## Sessions are the architecture
...
## The indexer is the interesting part
...
Part 3 adds the query session — ask questions across all your documents from the terminal. Same `createAgentSession()`, read-only tools, index-first file selection.

[GitHub →](https://github.com/satish860/llm-kb)

---

*[Part 1: No Embeddings](/articles/building-karpathy-knowledge-base-part-1) · [GitHub](https://github.com/satish860/llm-kb) · [Pi SDK](https://github.com/mariozechner/pi) · [LiteParse](https://github.com/run-llama/liteparse)*
