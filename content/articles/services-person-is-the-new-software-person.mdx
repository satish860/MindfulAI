...
keywords:
  ...
  - "AI professional services disruption"
  - "software vs services companies AI"
  - "merged firm model AI"
  - "AI document intelligence"
  - "outcome-based billing AI"
  - "domain expertise vs software engineering"
  - "AI replacing professional services"
  - "small firm AI advantage"
  - "Big 4 AI disruption"
  - "TCS McKinsey AI automation"
  - "aviation document processing AI"
  - "vibe coding vs production software"
  - "AI services firm revenue per person"
  - "professional services automation"
  - "5 person AI firm"
  - "Julien Bek services software"
  - "AI document processing production"
faq:
  - q: "Can a software company replace professional services firms using AI?"
    a: "No. Sequoia's thesis that a software company will become the next $1T services firm is incomplete. Domain judgment — like knowing an aviation maintenance reserve formula is technically correct but practically insufficient — requires 10+ years of scar tissue from real engagements. That knowledge isn't in any training dataset and won't emerge from better models or more data. AI handles intelligence work (reading, extracting, processing) but judgment work requires deep human expertise."
  - q: "Can service professionals learn to build production AI software through vibe coding?"
    a: "No. Vibe coding produces scripts that work on a laptop, not production software. Production systems require architecture for multi-client data flows, error handling for corrupted PDFs and API timeouts, deployment with Docker/CI/CD/SSL, monitoring for 3 AM failures, and handling hundreds of unexpected edge cases. Building production software, like domain expertise, requires years of systems breaking in ways you didn't expect."
  - q: "What is the merged firm model for AI services?"
    a: "The merged firm combines deep domain expertise and deep software engineering expertise in a small team (typically 3-5 people) augmented by AI. The AI handles intelligence work while domain experts provide judgment and software engineers build production systems. This model sells outcomes, not hours — delivering 10x output at a fraction of traditional cost. Revenue per person can reach EUR 178,000 vs. EUR 21,000 at large firms when all overhead is counted."
  - q: "Why can't large firms like TCS, McKinsey, or Big 4 copy the merged firm approach?"
    a: "Both TCS and McKinsey sell people-hours. AI that reduces headcount makes TCS smaller, not more profitable. A McKinsey engagement compressed from 6 weeks to 5 days makes the partner redundant. Restructuring means dismantling not just the 80% doing intelligence work, but also the 80% who manage, report on, and approve it. Large firm bureaucracy — politics layers, approval chains, reporting on reports, QA reviewing compliance reviewing risk — means only 30% of time goes to client work vs. 95% at a merged firm."
  - q: "What results does AI document intelligence achieve in production?"
    a: "Real production results include: aviation document processing reducing 40+ hours/week of manual work to minutes across 7 clients and 200+ documents/month at 95% accuracy; lease agreement extraction compressing 3 days (24 person-hours) per lease to 30 minutes for 377 fields and 7,200+ data points; and regulatory compliance work dropping from 6 weeks at EUR 150,000 (Big 4 pricing) to 10 days at EUR 15,000, with more comprehensive output covering 500+ requirements across 6 frameworks."
---
