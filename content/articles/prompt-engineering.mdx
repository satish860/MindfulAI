...
<div className="warning-box">
  <p><strong>Warning: Ambiguity in Instructions</strong></p>
  <p>Vague instructions lead to unpredictable results. Always be specific about format, length, and style.</p>
</div>
