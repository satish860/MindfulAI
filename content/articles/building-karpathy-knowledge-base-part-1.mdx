...
| **4** | [A wiki that organizes by concept, not filename](/articles/building-karpathy-knowledge-base-part-4) |
| **4.1** | [Building the wiki updater — code walkthrough](/articles/building-karpathy-knowledge-base-part-4-1) |
| **5** | [The self-correcting eval loop](/articles/building-karpathy-knowledge-base-part-5) |
| **5.1** | [Building the eval loop — code walkthrough](/articles/building-karpathy-knowledge-base-part-5-1) |
| **6** | [Verified citations — exact bounding boxes on the PDF](/articles/building-karpathy-knowledge-base-part-6-verified-citations) |
| **6.1** | [Building the citation engine — code walkthrough](/articles/building-karpathy-knowledge-base-part-6-1-citation-engine) |
