...
Requires: Node.js, [Pi coding agent SDK](https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent), and an LLM API key.
...
**Built with [Pi](https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent) coding agent. Evaluated on [Legal RAG Bench](https://isaacus.com/blog/legal-rag-bench) by Isaacus.**
