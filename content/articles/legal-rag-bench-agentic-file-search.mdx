...
faq:
  ...
  - q: "How does agentic file search compare to traditional RAG pipelines?"
    a: "On Legal RAG Bench (100 legal questions), agentic file search scored 93% correctness vs. 83.6% for the best embedding+LLM pipeline (Karon 2 + Gemini 3.1 Pro). Retrieval accuracy was 94% vs. ~91%, and groundedness was 97% vs. ~96%."
...
On Legal RAG Bench (100 legal questions), agentic file search scored 93% correctness vs. 83.6% for the best embedding+LLM pipeline (Karon 2 Embedder + Gemini 3.1 Pro). Retrieval accuracy was 94% vs. ~91%, and groundedness was 97% vs. ~96%. All results are reproducible — [run the eval yourself](https://github.com/satish860/legal-rag-bench).
